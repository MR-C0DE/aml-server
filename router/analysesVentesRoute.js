...
routerAnalysesVentes.get("/:id", AnalysesVentesController.getAnalysesVenteById);
...
routerAnalysesVentes.put("/:id", AnalysesVentesController.updateAnalysesVente);

// Supprimer une analyse de vente
routerAnalysesVentes.delete("/:id", AnalysesVentesController.deleteAnalysesVente);
